 ...
 *
 * IDENTIFICATION
 *	  contrib/shark/src/backend_parser/kwlist.h
 *
 * -------------------------------------------------------------------------
 */
...
PG_KEYWORD("cast", TSQL_CAST, RESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("exec", TSQL_EXEC, UNRESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("max", TSQL_MAX, UNRESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("output", TSQL_OUTPUT, UNRESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("rowlock", TSQL_ROWLOCK, UNRESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("tablock", TSQL_TABLOCK, UNRESERVED_KEYWORD, DIRECT_LABEL)
PG_KEYWORD("tablockx", TSQL_TABLOCKX, UNRESERVED_KEYWORD, DIRECT_LABEL)
...
PG_KEYWORD("xact_abort", XACT_ABORT, UNRESERVED_KEYWORD, DIRECT_LABEL)
