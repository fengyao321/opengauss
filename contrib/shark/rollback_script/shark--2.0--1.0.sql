...
DROP CAST IF EXISTS (sys.VARBINARY AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (pg_catalog.BYTEA AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.BYTEA) CASCADED;
DROP CAST IF EXISTS (pg_catalog.VARCHAR AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (pg_catalog.BPCHAR AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.BPCHAR) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY AS pg_catalog.VARCHAR) CASCADED;
DROP CAST IF EXISTS (INT2 AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (INT4 AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (INT8 AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (REAL AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (DOUBLE PRECISION AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as INT2) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as INT4) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as INT8) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as numeric) CASCADED;
DROP CAST IF EXISTS (numeric AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as date) CASCADED;
DROP CAST IF EXISTS (date AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as time) CASCADED;
DROP CAST IF EXISTS (time AS sys.VARBINARY) CASCADED;
DROP CAST IF EXISTS (sys.VARBINARY as smalldatetime) CASCADED;
DROP CAST IF EXISTS (smalldatetime AS sys.VARBINARY) CASCADED;
drop function if exists sys.varbinarytypmodin(cstring[]);
drop function if exists sys.varbinarytypmodout(integer);
drop function if exists sys.varbinaryrecv(internal, oid, integer);
drop function if exists sys.varbinarysend(sys.VARBINARY);
drop function if exists sys.varbinaryin(cstring, oid, integer);
drop function if exists sys.varbinaryout(sys.VARBINARY);
drop function if exists sys.varbinary(sys.VARBINARY, integer, boolean);
drop function if exists sys.byteavarbinary(pg_catalog.BYTEA, integer, boolean);
drop function if exists sys.varbinarybytea(sys.VARBINARY, integer, boolean);
...
drop function if exists sys.int4varbinary(INT4, integer, boolean);
drop function if exists sys.int8varbinary(INT8, integer, boolean);
drop function if exists sys.float4varbinary(REAL, integer, boolean);
drop function if exists sys.float8varbinary(DOUBLE PRECISION, integer, boolean);
drop function if exists sys.varbinaryint2(sys.VARBINARY);
drop function if exists sys.varbinaryint4(sys.VARBINARY);
drop function if exists sys.varbinaryint8(sys.VARBINARY);
drop function if exists sys.varbinary_numeric(sys.VARBINARY);
drop function if exists sys.numeric_varbinary(numeric, integer, boolean);
drop function if exists sys.varbinary_date(sys.VARBINARY);
drop function if exists sys.date_varbinary(date, integer, boolean);
drop function if exists sys.varbinary_time(sys.VARBINARY);
drop function if exists sys.time_varbinary(time, integer, boolean);
drop function if exists sys.varbinary_smalldatetime(sys.VARBINARY);
drop function if exists sys.smalldatetime_varbinary(smalldatetime, integer, boolean);
