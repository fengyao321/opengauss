...
PG_KEYWORD("asof", ASOF_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("constructor", CONSTRUCTOR, UNRESERVED_KEYWORD)
...
PG_KEYWORD("final", FINAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("imcstored", IMCSTORED, RESERVED_KEYWORD)
...
PG_KEYWORD("long", LONG, UNRESERVED_KEYWORD)
...
PG_KEYWORD("share_memory", SHARE_MEMORY, RESERVED_KEYWORD)
...
PG_KEYWORD("static", STATIC_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("timezone_hour", TIMEZONE_HOUR_P, UNRESERVED_KEYWORD)
PG_KEYWORD("timezone_minute", TIMEZONE_MINUTE_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("unimcstored", UNIMCSTORED, RESERVED_KEYWORD)
...
PG_KEYWORD("varray", VARRAY, UNRESERVED_KEYWORD)
