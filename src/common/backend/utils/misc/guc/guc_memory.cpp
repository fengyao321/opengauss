...
static void InitMemoryConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_rack_memory_cleaner",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Enable rack memory cleaner thread."),
            NULL},
        ...
        // variable to enable borrow memory for HTAP and operators
...
static void InitMemoryConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"max_borrow_memory",
            ...
            NULL,
            GUC_UNIT_KB},
            &g_instance.attr.attr_memory.max_borrow_memory_input,
            0,
            0,
            INT_MAX,
        ...
        {{"ss_max_imcs_cache",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the maximum size of ss imcs memory used by the process."),
            NULL,
            GUC_UNIT_KB},
            &g_instance.attr.attr_memory.ss_max_imcs_cache,
            128 * 1024,
            0,
            INT_MAX,
            NULL,
