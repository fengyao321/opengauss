...
DataVec向量数据库可通过[容器镜像安装](https://docs.opengauss.org/zh/docs/latest-lite/installation_guide/installing_the_container_image.html)快速部署，并快速对接大模型，打造本地RAG智能问答服务。

DataVec向量数据库可通过安装[spqplugin_v2插件](https://docs.opengauss.org/zh/docs/latest-lite/extension_reference/extension_reference/plugin/spqplugin_v2.html)，在大数据量场景下获得数据库分布式存储检索能力。
