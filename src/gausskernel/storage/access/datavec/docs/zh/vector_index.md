...
- `ef_search` - 查询时的动态候选集大小（默认为40），详情请参考[DataVec向量引擎参数](https://docs.opengauss.org/zh/docs/latest/database_reference/datavec_vector_engine_parameters.html)。
...
- `probe` - 查询时候选集的大小（默认为1），详情请参考[DataVec向量引擎参数](https://docs.opengauss.org/zh/docs/latest/database_reference/datavec_vector_engine_parameters.html)。
...
- `diskann_probes` - 查询时候选集的大小（默认为128），详情请参考[DataVec向量引擎参数](https://docs.opengauss.org/zh/docs/latest/database_reference/datavec_vector_engine_parameters.html)。
