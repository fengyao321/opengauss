...
- 部署openGauss-DataVec容器实例，教程可参考[openGauss-DataVec容器镜像安装](https://docs.opengauss.org/zh/docs/latest/installation_guide/installing_the_container_image.html)
...
有关具体参数的修改，请参考 **[GUC参数说明](https://docs.opengauss.org/zh/docs/latest/database_reference/guc_parameter_usage.html)** 
