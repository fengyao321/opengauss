...
DataVec向量数据库可通过安装[spqplugin_v2插件](https://docs.opengauss.org/zh/docs/latest/extension_reference/extension_reference/plugin/spqplugin_v2.html)，在大数据量场景下获得数据库分布式存储检索能力。
